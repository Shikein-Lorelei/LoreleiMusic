...
export const SongProvider = ({ children }) => {
    ...
    const fetchAllSongs = () => {
        fetch('https://lorelei-music-production.up.railway.app/api/songs')
            .then((res) => res.json())
            .then(setAllSongs)
            .catch(console.error);
    };
    ...
    const editSong = async (songId, updatedData) => {
        try {
            const response = await fetch(`https://lorelei-music-production.up.railway.app/api/songs/${songId}`, {
                method: 'PUT',
                headers: {
